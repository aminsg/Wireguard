...
- اگر نتوانستید کانفیگ ها یا Peers رو پاک کنید ، وایرگارد را روشن و خاموش کنید و دوباره تلاش نمایید.در صورت عدم موفقیت ، پرایوت کی هر Peer رو پاک و آن را ذخیره و سپس حذف کنید.
- ممکن است تانل شما پکت ها رو جا به جا نکند ، حتما به همون روش بالا، وایرگارد رو نصب کنید تا این مشکل برای شما پیش نیاید.ممکن است گاهی اوقات به دلیل انتخاب نادرست ایپی باشد.
