    ...
    function configurationPeers(response) {
        ...
        if (response.peer_data.length === 0) {
            ...
            response.peer_data.forEach(function (peer) {
                ...
                let peer_enable = '<div class="col-sm"><small class="text-muted"><strong>Status</strong></small><h6 style="text-transform: uppercase;">' + (peer.is_enabled ? 'Enabled' : 'Disabled') + '</h6></div>';
