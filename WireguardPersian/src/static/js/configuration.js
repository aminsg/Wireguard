    ...
    function configurationPeers(response) {
        ...
        if (response.peer_data.length === 0) {
            ...
            response.peer_data.forEach(function (peer) {
                ...
                let peer_enable = '<div class="col-sm"><small class="text-muted"><strong>وضعیت</strong></small><h6 style="text-transform: uppercase;">' + (peer.end_active ? 'فعال' : 'غیرفعال') + '</h6></div>';
